package com.loewensteinmedical.polarion.core.utils;
 ...
 * @author Markus Weber
 * @since 1.0.0
 * @see <a href="https://polarion.weinmann.com/polarion/#/project/ToolValidation/workitem?id=TOOL-2851">TOOL-2851</a>
 */
public class StringUtils {
	 ...
	 * @param throwErrors If true replacement errors are thrown. Otherwise null is returned
	    ...
	    while(matcher.find()) {
	    	...
	    	switch(value.getClass().getSimpleName()) {
		    	...
		    	case "PObjectTypedList":
		    		for (IPObject valueObject : (IPObjectList<IPObject>) value) {
		    		...
		    		break;
		    	case "ModelTypedList":
		    		for (IApprovalStruct valueObject : (ModelTypedList<IApprovalStruct>) value){
	...
	/**
	 * Executes a calculation formulated as a String and returns the final value as a String
	 * @param originalString String
	 * @param calcPattern Specifies which part should be considered as a calculation
	 * @return Replaced String
	 */
