...
//
//        UserFriendlyRuntimeException exception = assertThrows(UserFriendlyRuntimeException.class, () -> pdfExportFunction.savePdfAsWorkItemAttachment(module, params, "TargetStatus", args, new byte[0], "AAW-1"));
...
//        pdfExportFunction.savePdfAsWorkItemAttachment(module, params, "TargetStatus", args, new byte[0], "AAW-1");
